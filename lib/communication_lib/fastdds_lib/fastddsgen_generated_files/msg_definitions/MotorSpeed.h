...
#ifndef _IDL_MSG_MOTORSPEED_H_
#define _IDL_MSG_MOTORSPEED_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(MotorSpeed_SOURCE)
#define MotorSpeed_DllAPI __declspec( dllexport )
#else
#define MotorSpeed_DllAPI __declspec( dllimport )
#endif // MotorSpeed_SOURCE
#else
#define MotorSpeed_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define MotorSpeed_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    ...
    public:
         ...
         * @param x Reference to the object idl_msg::MotorSpeed that will be copied.
         */
        eProsima_user_DllExport MotorSpeed(
                const MotorSpeed& x);
         ...
         */
        eProsima_user_DllExport void motor_speed(
                float _motor_speed);
